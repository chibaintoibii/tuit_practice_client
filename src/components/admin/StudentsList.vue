  ...
  <div class="container-fluid">
    <div class="row mt-3">
      ...
      <div class="col-9 d-flex justify-content-end">
        <button class="btn btn-custom-primary me-3" @click="this.showModal = true"><i class="fa-solid fa-user-plus"></i>
          {{ this.$localeToText('add_new_student') }}
        </button>
          ...
          <tr>
            ...
            <th scope="col">
              <span style="cursor: pointer;" @click="sortBy(2)">
                  {{ this.$localeToText('group_name') }} <i class="fa-solid ms-1"
          ...
          <tr v-for="o in 15">
            ...
            <td style="letter-spacing: 1px;">
              <router-link :to="`/admin/teachers/${'chibaintoibii'}`"
                           class="text-decoration-underline text-custom-dark">chibaintoibii
              </router-link>
            </td>
            <td>KIF 211-20</td>
